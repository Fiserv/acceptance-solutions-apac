...
|`taxidType`|Alphanumeric|50|M|For AU - ABN "" ""Tax ID Type providedfor the merchant For India: Individual PAN for Individual/Soleprop merchants
|
...
|`identitymetaName1`|Alphanumeric|100|O|Additional information pertaning to the KYC docuements submitted. For AU - Driving License State Code|
|`identitymetaValue1`|Alphanumeric|100|O|Additional information pertaning to the KYC docuements submitted. For AU - Value Driving License State Code|
...
|`contactName`|Alphanumeric|35|O|Contact name of the Merchant|
|`idDocDetails`|-||NA|ID Doc Details section is a conditional tag and has to be mandatorily present if the user is uploding documents for a particular application|
|`idDocDetails`|-||NA|All documents uploaded under ""categoryInd"": ""P"" has to be included under principalDetails.idDocDetails|
...
|`identitymetaName1`|Alphanumeric|100|NA|Additional information pertaning to the KYC docuements submitted for UBO|
|`identitymetaName1`|Alphanumeric|100|NA|For AU - Driving License State Code|
|`identitymetaValue1`|Alphanumeric|100|NA|Additional information pertaning to the KYC docuements submitted|
|`identitymetaValue1`|Alphanumeric|100|NA|For AU - Value Driving License State Code"|
