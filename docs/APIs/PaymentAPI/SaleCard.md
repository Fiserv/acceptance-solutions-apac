...
|`convFee`|String |10|C|Convenience Fee including decimal (E.g: “50.00” for $50 sale). Send 0.00 for inquiry transactions and Get Token.|
|`cgst`|String |10|C|Central GST Including decimal (E.g: “50.00” for $50 sale). Send 0.00 for inquiry transactions and Get Token.|
|`igst`|String |10|C|Integrated GST Including decimal (E.g: “50.00” for $50 sale). Send 0.00 for inquiry transactions and Get Token.|
|`sgst`|String |10|C|State GST Including decimal (E.g: “50.00” for $50 sale). Send 0.00 for inquiry transactions and Get Token.|
|`gst`|String |10|C|GST - applicable except India|
|`totalAmount`|String |12|M|Total Amount (auth, fee, gsts) including decimal (E.g: “50.00” for $50 sale). Send 0.00 for inquiry transactions and Get Token.|
...
|`gst`|String|10|O|Same value as request table.<br>GST - applicable except India|
