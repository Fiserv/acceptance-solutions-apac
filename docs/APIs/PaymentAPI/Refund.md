...
| `tipAmount` | *string* | 10 | C | Last 4 Dresponseigits of Card Number. To be included for PreAuth completion transaction. |
...
| `custId` | *string* | 35 | O | Customer identifier,Vehicle number for FASTag VPA for UPI QR. |
