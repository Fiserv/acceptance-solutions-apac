...
This API is used to send settlement transaction request. Merchants will be required to add session 
...
| `igst` | *string* | 10 | C | Central GST Including decimal (E.g. 10.00 for $10 igst).If IGST is included in the total amount |
| `sgst` | *string* | 10 | C| Central GST Including decimal (E.g. 10.00 for $10 sgst).If SGST is included in the total amount |
